        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: CustomButton(
                height: 50,
                title: UiUtils.getTranslatedLabel(context, bookAppoinmentKey),
        ...
        children: <Widget>[
          ...
          CircleAvatar(
            ...
            backgroundImage: NetworkImage(
              !doctor['doctor_profile'].contains("https://")
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Config.spaceSmall,
          Text(
            'Dr. ${doctor['doctor_name']} is an experience ${doctor['category'] ?? "Public medical"} Specialist at Sarawak, graduated since 2008, and completed his/her training at Sungai Buloh General Hospital.',
            style: const TextStyle(
              fontWeight: FontWeight.w500,
              height: 1.5,
            ),
