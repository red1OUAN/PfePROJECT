                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        final rating = await DioProvider().cancelAppoinment(
                            widget.doctor['appointments']
                                ['id'], //this is appointment id
                            token);
                        // final response =
                        //     await DioProvider().getAppointments(token);
                        // final appointment= json.encode(response.data);
//                           List<dynamic> jsonData = json.decode(response);
// List<Map<String, dynamic>> appointment = List<Map<String, dynamic>>.from(jsonData);
//                             print(appointment);
                        ...
                        showDialog(
                            ...
                            builder: (context) {
                              return RatingDialog(
                                  ...
                                  // image: Container(image:AssetImage()),
